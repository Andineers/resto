...
function displayItems() {
    ...
    var ChinaFood= document.getElementById('ChinaFood');
    var JapanesseFood= document.getElementById('JapanesseFood');
    var KoreanFood= document.getElementById('KoreanFood');
    var Vegetable= document.getElementById('Vegetable');

    const BriyaniData= foodItem.filter((item)=>item.category=='Briyani');
    const ChickenData= foodItem.filter((item)=>item.category=='Chicken');
    const ChinaFoodData= foodItem.filter((item)=>item.category=='ChinaFood');
    const JapanesseFoodData= foodItem.filter((item)=>item.category=='JapanesseFood');
    const KoreanFoodData= foodItem.filter((item)=>item.category=='KoreanFood');
    ...
    ChinaFoodData.map(item=>{
       ...
       ChinaFood.appendChild(itemCard)

    })

   JapanesseFoodData.map(item=>{
        var itemCard= document.createElement('div');
        itemCard.setAttribute('id','item-card')
        ...
        JapanesseFood.appendChild(itemCard)
    
    })

    KoreanFoodData.map(item=>{
        var itemCard= document.createElement('div');
        itemCard.setAttribute('id','item-card')
        ...
        KoreanFood.appendChild(itemCard)
